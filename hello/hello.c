...
Per svolgere questo esercizio è sufficiente riuscire a compilare
il programma usando il proprio ambiente di sviluppo, ed eseguirlo
passando un parametro sulla riga di comando. Ciò sarà necessario
per tutti gli esercizi futuri.
